...
connection = pymysql.connect(
    host='localhost',    # db hostname according to localhost 
    user='root',              # username  of free sql db
    password='',            # pwd  of free sql db
    database='pythonlogin',              #db name of free sql db
)
